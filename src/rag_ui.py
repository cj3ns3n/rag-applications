...
from app_functions import (convert_seconds, search_result, validate_token_threshold, stream_chat, load_data)
from app_functions import (get_retriever, get_reranker, get_llm)
...
MINI_READER_MODEL = 'gpt-4o-mini'
RETRIEVER_MODEL = 'sentence-transformers/all-MiniLM-L6-v2'

ICON_DIR = './app_assets/'
collection_name = None
data_path = '../data/huberman_labs.json'
embedding_model_path = '../data/huberman-allminilm-finetuned-256.parquet'
...
available_collections = ['Huberman_minilm_256'] # only one collection available
...
def main(retriever: WeaviateWCS):
    ...
    # retriever.return_properties.append('expanded_content') #expanded inserted in the Huberman_minilm_256
